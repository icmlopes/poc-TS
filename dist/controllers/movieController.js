    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.trys.push([1, 3, , 4]);
                    return [4 /*yield*/, R.insertMovie(newMovie)];
                case 2:
                    _a.sent();
                    return [3 /*break*/, 4];
                case 3:
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    return [2 /*return*/, res.status(200).send(existingMovies.rows)];
                case 2:
                    error_2 = _a.sent();
                    console.log(error_2);
                    return [2 /*return*/, res.sendStatus(500)];
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    getByid = _a.sent();
                    return [2 /*return*/, res.status(200).send(getByid.rows)];
                case 3:
                    error_3 = _a.sent();
                    console.log(error_3);
                    return [2 /*return*/, res.sendStatus(500)];
...
export function status(req, res) {
    return __awaiter(this, void 0, void 0, function () {
        var id, getComment, getMovieId, error_4;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    id = Number(req.params.id);
                ...
                case 2:
                    ...
                    return [4 /*yield*/, R.updateStatus(getComment, id)];
                case 3:
                    _a.sent();
